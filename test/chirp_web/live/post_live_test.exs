defmodule ChirpWeb.PostLiveTest do
  ...
  @create_attrs %{body: "some body", like_count: 42, reposts_count: 42, username: "some username"}
  @update_attrs %{body: "some updated body", like_count: 43, reposts_count: 43, username: "some updated username"}
  @invalid_attrs %{body: nil, like_count: nil, reposts_count: nil, username: nil}
